...
![](./images/vinyl-crate-visual-studio-code.png)
...
![](./images/vscode-pick-project.png)

Now, open up the `Startup.cs` class.

![](./images/vinyl-crate-startup.png)
...
![](./images/vs-code-new-folder.png)

![](./images/vc-views-controllers.png)

Inside of "Views", create a folder named "Home":

![](./images/vc-views-home.png)

Inside of "Controllers", create a `HomeController.cs`:

![](./images/vc-home-controller.png)
...
![](./images/vc-hello-world-view.png)
